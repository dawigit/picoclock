...
extern PAINT_TIME Paint_time;
extern bool Paint_ext;
//init and Clear
...
void Paint_DrawString_ENx(UWORD Xstart, UWORD Ystart, const char * pString, sFONT* Font, UWORD Color_Foreground, UWORD Color_Background,bool ext);
